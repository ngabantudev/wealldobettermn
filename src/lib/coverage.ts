...
export const TURNOUT_NOTE =
  "Election turnout is mapped for Minnesota cities across seven general elections — 2012, 2014, 2016, 2018, 2020, 2022, and 2024, selectable via the map's own year slider — no other election type yet (no primaries or special elections), and no county-level aggregation. Cities under 200 registered voters show a raw vote count but no percentage (too small to shade reliably). \"Turnout of CVAP\" is null for at least one city per year where the join to Census citizen-voting-age-population data didn't resolve. Townships and unorganized territory have no city government and so no turnout figure to show — they're marked on the map as their own distinct class rather than left blank.";
