// Data for MastheadSaying.tsx — the auto-rotating line under the "We All
// Do Better" wordmark in SiteHeader. Eight mottos from Minnesota's
...
export interface MastheadSaying {
  ...
  community: string;
  /** The phrase itself, in its own language — this is what's always visible in the masthead. */
  quote: string;
